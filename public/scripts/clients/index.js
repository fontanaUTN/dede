...
// Slider images
const arrSliderContent = document.querySelectorAll('.slider__inner');
let contadorSliderItems = 0;

const slider = (arrSliderItems) => {
...
setInterval(function() {
   arrSliderContent.forEach((content) => {
      let arrSliderItems = content.querySelectorAll('.slider__item');
      slider(arrSliderItems);
   })
}, 4000)
